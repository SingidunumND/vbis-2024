...
class ReportModel extends BaseModel
{
    ...
    public function getNumberOfReservationsPerMonth()
    {
        ...
        $dbResult = $this->con->query("SELECT MONTHNAME(reservation_time) as 'month', count(id) as 'number_of_reservations'
                                                FROM reservations where id_user = $id_user group by MONTHNAME(reservation_time);");
    ...
    public function getPricePerMonth()
    {
        ...
        $dbResult = $this->con->query("SELECT MONTHNAME(reservation_time) as 'month',  sum(price) as 'price'
                                FROM reservations where id_user = $id_user group by MONTHNAME(reservation_time);");
